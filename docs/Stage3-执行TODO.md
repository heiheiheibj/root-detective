...
| 步骤 | 内容 |
|---|---|
| **S6c** | ① **词素可用性门槛**（见下，最要紧）② 世界划分：96 个教学词根分成 15~25 个世界并命名 ③ 改 A24 检查口径——现在要求「每个词根都要挂世界」，但 batch-02 里 298 个词根里有 202 个是零件词根（<3 词），不该要求世界 |
...
**已知遗留**：
- 232 个教学词素的**中文义项待翻译**（`.work/derived/translate-queue.json`）
